...
- Items under "Adjournment Slips" (or marked "Adj Slip") go in adjournment_slips, NOT in blocks. They are called quickly at the start and stay in the official serial queue.
